...
# colnames(rawdata)
# 观察总浓度与深度关系
plot(rawdata$Depth..feet.,rawdata$Total.PCBs..0.DL..pg.g,xlab = 'PCBs总浓度(pg/g)', ylab = '采样点深度', main = '双变量关系探索')
# bootstrap重采样
...
plot(data$Total.PCBs~data$Depth,xlab = 'PCBs总浓度(pg/g)', ylab = '采样点深度(m)', main = '双变量关系探索')
lines(data$Depth,fit$fitted,lwd=3)

# p值0.001525 r^2 0.1294

fit2 <- loess(data$Total.PCBs~data$Depth)
plot(data$Total.PCBs~data$Depth,xlab = 'PCBs总浓度(pg/g)', ylab = '采样点深度(m)', main = '双变量关系探索')
lines(lowess(data$Depth,fit2$fitted),lwd=3)

# 局部加权回归散点平滑法

plot(data$Total.PCBs~data$Depth, pch = 20, col = rgb(0, 0, 0, 0.5),xlab = 'PCBs总浓度(pg/g)', ylab = '采样点深度(m)', main = '双变量关系探索')
for (i in 1:300){
...
abline(v = cic, col = "blue", lwd=2)
abline(v = cie, col = "red", lwd=2)
abline(v = mean(data$Total.PCBs), col = "black",lwd=2)
abline(v = median(data$Total.PCBs), col = "yellow",lwd=3)
abline(v = exp(mean(log(data$Total.PCBs))), col = "green",lwd=3)
